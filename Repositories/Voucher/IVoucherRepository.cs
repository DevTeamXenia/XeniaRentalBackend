...
namespace XeniaRentalBackend.Repositories.Voucher
{
    public interface IVoucherRepository
    {
        ...
        Task<object> GetCollectionStatusAsync( int companyId, int userId, DateTime? fromDate, DateTime? toDate, int? propertyId, int? unitId, string? voucherStatus, string? search, int pageNumber = 1, int pageSize = 25);
        ...
        Task<object> GetTenantChargesByMonthAsync( int companyId, int userId, int month, int year, int? propertyId = null, int? unitId = null, int? bedSpaceId = null, string? search = null, int pageNumber = 1, int pageSize = 25);
