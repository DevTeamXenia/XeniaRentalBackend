...
namespace XeniaRentalBackend.Repositories.TenantAssignment
{
    public interface ITenantAssignmentRepository
    {
        ...
        Task<IEnumerable<TenantAssignmentGetDto>> GetByCompanyAllId(int companyId, int userId, int? unitId = null);
        Task<object> GetByCompanyIdAsync(int companyId, int userId, bool isBedSpace = false, DateTime? startDate = null, DateTime? endDate = null, int? propertyId = null, int? unitId = null, string? search = null, int pageNumber = 1, int pageSize = 25);
        Task<object> GeClosure( int companyId, int userId, DateTime? startDate = null, DateTime? endDate = null, int? propertyId = null, int? unitId = null, string? search = null, int pageNumber = 1, int pageSize = 25);
